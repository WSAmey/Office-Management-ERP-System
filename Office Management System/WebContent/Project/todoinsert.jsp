...
<body>
<%
String toEmp=request.getParameter("empname");
...
session.setAttribute("Message12", "Task Added Successfully!");
...
if(uresult.last()){
	...
	st.executeUpdate("insert into todo (toemp,taskdesc,category,priority,taskstatus,fromdate,todate,id,whours,taskupdate) values('"+toEmp+"','"+taskDesc+"','"+category+"','"+priority+"','"+taskstatus+"','"+fromdate+"','"+todate+"','"+uid+"','"+ufname+"','"+whours+"','')");
}
