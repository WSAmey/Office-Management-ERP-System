        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;border:none; width: 1434px; margin-left: -335px;" >
          <div class="card-body p-4 p-md-5" style="background-color: white;border-radius: 15px;">
            ...
            <form  action="update.jsp" >
					<input name="flag" value="yourtask" type="hidden">
			...
			<div class="form-floating" style="background-color: white;">
  			<textarea class="form-control form-control-lg w-100" name="taskdesc" id="floatingTextarea2" style="height: 100px;pointer-events:none;" ><%= taskdesc %></textarea>
			</div>
			</div>
		<br>
              <div class="row" style="background-color: white;">
        ...
        <div class="row" style="background-color: white;">
                ...
                <div class="col-12" style="background-color: white;">
                  ...
                  <div class="form-outline" style="background-color: white;">
                    ...
                    <input type="date" id="my_date_picker1" style="pointer-events:none;" class="form-control form-control-lg w-100" name="todate" autocomplete="off" value="<%= todate %>"/>
			...
			<div class="form-floating" style="background-color: white;">
  			<textarea class="form-control form-control-lg w-100" name="taskupdate" id="floatingTextarea2" style="height: 65px;" ><%= taskupdate %></textarea>
                 ...
                 <div class="row" style="background-color: white;">       
                  ...
                  <select class="select form-control-lg " name="status" id="tstatus">
                 ...
                 <br>
                  ...
                  <select class="select form-control-lg " id="whours" name="whours">
			...
			<div class="mt-4 pt-2 text-center"
								...
								<div class="mt-4 pt-2 float-right"
									...
									<a class="btn btn-danger btn-lg "
										...
										href="viewyourtask.jsp?flag=cancel">Cancel</a>
								</div>
